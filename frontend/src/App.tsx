...
//this function provides the header
function Welcome() {
  return (
    <header className="App-header">
      <h1>Welcome to March Madness! See which teams who will be battling it out in this year's NCAA tournament!</h1>
    </header>
    );
}

//this class handles the card info for each team
...
//this function prints out the list of teams with their info
function TeamList() {
  return (
    <div>
      {teams.map(oneTeam => <Team {...oneTeam}/>)}<br/>
    </div>
  );
}

//this function puts all the info together
function App() {
  return (
    <div>
      <Welcome/>
